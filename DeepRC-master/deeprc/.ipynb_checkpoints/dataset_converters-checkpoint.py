...
class DatasetToHDF5(object):
    ...
    def _read_aa_sequence(self, filename):
        ...
        try:
            ...
            amino_acid_sequences = np.full(shape=(len(sequences_str), max_seq_len), dtype=int, fill_value=-1)
    ...
    def save_data_to_file(self, output_file: str, n_workers: int = 50, large_repertoires: bool = False):
        ...
        with h5py.File(output_file, 'w') as hf:
            ...
            group.create_dataset('sequences', data=amino_acid_sequences, dtype=int, **self.h5py_dict)
